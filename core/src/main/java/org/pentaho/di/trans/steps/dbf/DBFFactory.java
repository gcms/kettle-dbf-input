...
public class DBFFactory {
  public static DBF createDBF( LogChannelInterface log, FileObject fileObject, String fileCompression ) throws KettleException {
    try {
      InputStream is = KettleVFS.getInputStream( fileObject );
      return new DBF( log, fileObject.getName().getPath(), decompress( is, fileCompression ) );
  ...
  public static DBF createDBF( LogChannelInterface log, String filePath, String fileCompression ) throws KettleException {
    try {
      InputStream is = new BufferedInputStream( new FileInputStream( filePath ) );
      return new DBF( log, filePath, decompress( is, fileCompression ) );
    } catch ( DBFException e ) {
      throw new KettleException( "Error opening DBF metadata", e );
    } catch ( IOException e ) {
      throw new KettleException( "Error reading DBF file", e );
